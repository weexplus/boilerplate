...
- (instancetype)initWithType:(MNAssistiveTouchType)type
    ...
    if (self = [super init]) {
        ...
        frame = CGRectMake(0, screenH/2, floatBtnW, floatBtnH);
        self.frame = frame;
    }
    return self;
}
...
-(void)addBtns{
    ...
    [set setTitleColor:[@"#ffffff" toColor] forState:UIControlStateNormal];
    [set setTitleColor:[UIColor redColor] forState:UIControlStateHighlighted];
    [_floatWindow.rootViewController.view addSubview:set];
    __weak typeof (self)weakself=self;
    WXNormalViewContrller *vc=  [[UIApplication sharedApplication].keyWindow.rootViewController TopViewController];
    
    [set mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(_floatWindow.rootViewController.view);
        make.right.equalTo(_floatWindow.rootViewController.view);
        make.bottom.equalTo(_floatWindow.rootViewController.view);
    ...
    [refresh setTitleColor:[@"#ffffff" toColor] forState:UIControlStateNormal];
    [refresh setTitleColor:[UIColor redColor] forState:UIControlStateHighlighted];
    [_floatWindow.rootViewController.view addSubview:refresh];
    [refresh mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(_floatWindow.rootViewController.view);
        make.right.equalTo(_floatWindow.rootViewController.view);
        make.top.equalTo(_floatWindow.rootViewController.view);
        make.height.equalTo(@(30));
    }];
    [refresh addClick:^{
        WXNormalViewContrller *cvc=  [[UIApplication sharedApplication].keyWindow.rootViewController TopViewController];
...
//        NSLog(@"xxxx");
//    }];
    [self.window bringSubviewToFront:set];
     [self.window bringSubviewToFront:refresh];
}
...
//        [self setTitle:title forState:UIControlStateNormal];
        self.backgroundColor=[@"#000000" toColor:0.4];
