...
var indicate = __webpack_require__(104);
exports.default = {
...
__vue_options__.__file = "/Users/zhengjiangrong/Documents/GitHub/weexplus/src/demo/viewpagerTest.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-05d3e454"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var viewpager = __webpack_require__(427);
...
exports.default = {
  ...
  filters: {
    getFontName: function getFontName(text) {
  ...
  methods: {
    ...
    animateLine: function animateLine(fromindex, toindex) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(25)(module), __webpack_require__(5)))
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
      ...
      style: {
        'color': index == _vm.selectIndex ? _vm.selectedColor : _vm.textColor
      },
      on: {
        "click": function($event) {
          _vm.itemClick(index)
    ...
    }, [_vm._v(_vm._s(_vm._f("getFontName")(item.src)))]) : _vm._e(), _c('text', {
      ref: 'text' + index,
      refInFor: true,
      staticStyle: {
        fontSize: "28",
