...
WX_EXPORT_METHOD(@selector(show:style:param:clickdismiss:))
WX_EXPORT_METHOD(@selector(dismiss))
@synthesize weexInstance;


-(void)show:(NSString*)url  style:(NSMutableDictionary*)style  param:(NSMutableDictionary*)param clickdismiss:(BOOL)clickdismiss
{
