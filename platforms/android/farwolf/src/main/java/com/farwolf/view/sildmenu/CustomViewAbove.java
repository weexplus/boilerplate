...
public class CustomViewAbove extends ViewGroup {
	...
	private boolean isInIgnoredView(MotionEvent ev) {
		...
		for (View v : mIgnoredViews) {
			...
			{
				if(ignoreListerner!=null)
				{
					if(ignoreListerner.isIgnored(v))
						return true;
				}
	...
	public void setIgnoreListerner(IgnoreListerner ignoreListerner) {
		this.ignoreListerner = ignoreListerner;
	}

	IgnoreListerner ignoreListerner;
	public static interface  IgnoreListerner
	{
		public boolean isIgnored(View v);
	}
