...
import com.farwolf.qrcode.zxing.decode.DecodeThread;
import com.farwolf.qrcode.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	public void handleMessage(Message message) {
		...
		else if(v== R.id.launch_product_query) {
