...
public class MonthView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldW, int oldH) {
        ...
        int cellW = (int) (w / 7F);
        int cellH4 = (int) ((h / 4F)*0.75);
        int cellH5 = (int) ((h / 5F)*0.75);
        int cellH6 = (int) ((h / 6F)*0.75);

        circleRadius = (int)(cellW*0.75);

        animZoomOut1 = (int) ((cellW * 1.2F)*0.75);
        animZoomIn1 = (int) (cellW * 0.8F);
        animZoomOut2 = (int) ((cellW * 1.1F)*0.75);
    ...
    private void computeDate() {
        ...
        if (null != onDateChangeListener) {
            ...
            String time=centerYear+"-";
            if(centerMonth<10)
              time+="0"+centerMonth;
            else
                time+=centerMonth;
            onDateChangeListener.onTimeChange(time);
        }
    }
