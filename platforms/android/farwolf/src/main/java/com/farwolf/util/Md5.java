...
public class Md5 {
	...
	public String getMD5(String s)
	{
		...
		try {
			b = s.getBytes("UTF-8");
			return getMD5ofString(b,b.length);
	...
	public static String toMd5(String s)
	{
		...
		if(s==null)
			...
			try {
				return md5.getMD5ofString(s.getBytes("UTF8"),s.getBytes("UTF8").length);
	...
	public static void main(String[] args) {
        String msgbody="Testtest123D111203154221555112000410";

		Md5 md5 = new Md5();
		//System.out.println(data);

			try {
				System.out.println(md5.getMD5ofString(msgbody.getBytes("UTF8"),msgbody.getBytes("UTF8").length));
