package com.farwolf.view.calendar.views;
...
import com.farwolf.view.calendar.bizs.calendars.DPCManager;
import com.farwolf.view.calendar.bizs.decors.DPDecor;
import com.farwolf.view.calendar.bizs.languages.DPLManager;
import com.farwolf.view.calendar.bizs.themes.DPTManager;
import com.farwolf.view.calendar.cons.DPMode;
import com.farwolf.view.calendar.entities.DPInfo;
import com.farwolf.view.calendar.utils.MeasureUtil;
...
public class DatePicker extends LinearLayout {
    ...
    public void setOnMonthChangeListener(OnDatePickedListener onMonthChangeListener) {
        this.onMonthChangeListener = onMonthChangeListener;
    }

    private OnDatePickedListener onMonthChangeListener;
    /**
     * 日期单选监听器
     */
    ...
    public DatePicker(Context context, AttributeSet attrs) {
        ...
        monthView.setOnDateChangeListener(new MonthView.OnDateChangeListener() {
            ...
            @Override
            public void onTimeChange(String date) {
                if (null != onMonthChangeListener) {
                    onMonthChangeListener.onDatePicked(date);
                }
            }
        });
