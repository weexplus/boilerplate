...
public class WXFWeb extends WXComponent {
    ...
    @Deprecated
    public WXFWeb(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, String instanceId, boolean isLazy) {
...
//        mWebView =new WXWebView(getContext())
    ...
    public void setUrl(String url) {
        ...
        if (!TextUtils.isEmpty(url)) {
            ...
            {
                ((WXWebView)getWebView()).mWebView.loadData(url,"text/html; charset=UTF-8",null);
