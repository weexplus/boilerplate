...
public class WSEventReporter {
    ...
    private static class WSHeaderCommon implements NetworkEventReporter.InspectorHeaders {
        ...
        private List<Pair<String, String>> headerList = new ArrayList<Pair<String, String>>();

        public void attachHeaders(Map<String, String> headers) {
            for (Map.Entry<String, String> entry : headers.entrySet()) {
                headerList.add(new Pair<String,String>(entry.getKey(), entry.getValue()));
            }
        }

        public void addHeader(String key, String value) {
            headerList.add(new Pair<String,String>(key, value));
        }
