...
public class AppTool {
    ...
    {
        android.app.ActivityManager am = ( android.app.ActivityManager)activity.getSystemService(activity.ACTIVITY_SERVICE);
    ...
    {
        List<Activity> l=  ActivityManager.getActivitiesByApplication(ac.getApplication());
        for(Activity a:l)
        {
            a.finish();
        }
