...
public abstract class PhotoBaseActivity extends Activity implements EasyPermissions.PermissionCallbacks{
    ...
    protected void takePhotoAction() {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            int checkCallPhonePermission = ContextCompat.checkSelfPermission(PhotoBaseActivity.this, Manifest.permission.CAMERA);
            if(checkCallPhonePermission != PackageManager.PERMISSION_GRANTED){
                ActivityCompat.requestPermissions(PhotoBaseActivity.this,new String[]{Manifest.permission.CAMERA},222);
                return;
            }
        }
...
//        }
        ...
        String fpath=takePhotoFolder+ "IMG" + DateUtils.format(new Date(), "yyyyMMddHHmmss") + ".jpg";
        this.savePath=fpath;
